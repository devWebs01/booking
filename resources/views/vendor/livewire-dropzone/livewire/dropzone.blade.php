<div x-cloak x-data="dropzone({
    ...
    <div
        class="d-flex flex-column align-items-start h-100 w-100 max-w-2xl justify-content-center bg-white border border-light rounded-3 p-4">
        ...
        <div class="dz-flex dz-justify-between dz-w-full">
            <label for="upload"
                class="dz-font-medium dz-text-lg dz-mb-2 dz-text-black dark:dz-text-white">{{ __('Upload files') }}
                <span class="dz-text-red-500">*</span></label>
        ...
        <div @click="$refs.input.click()"
            ...
            <div>
                <div x-show="!isDragging"
                    class="dz-flex dz-items-center dz-bg-gray-50 dz-justify-center dz-gap-2 dz-py-8 dz-h-full dark:dz-bg-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                    ...
                    <p class="dz-text-md dz-text-gray-600 dark:dz-text-gray-400">Drop here or <span
                            class="dz-font-semibold dz-text-black dark:dz-text-white">Browse files</span></p>
                </div>
                <div x-show="isDragging"
                    class="dz-flex dz-items-center dz-bg-gray-100 dz-justify-center dz-gap-2 dz-py-8 dz-h-full">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        class="dz-w-6 dz-h-6 dz-text-gray-500 dark:dz-text-gray-400">
                        <path
                        ...
                        <div class="dz-flex dz-items-center dz-gap-3">
                            @if ($this->isImageMime($file['extension']))
                                <div class="dz-flex-none dz-w-14 dz-h-14">
                                    <img src="{{ $file['temporaryUrl'] }}" class="img object-fit-cover"
                                        alt="{{ $file['name'] }}">
                                </div>
                            @else
                                <div
