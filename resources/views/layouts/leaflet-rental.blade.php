...
<script>
    ...
    function initializeMap(center, zoom) {
        ...
        control = L.Routing.control({
            waypoints: [
                L.latLng(null),
                rentalLocation // Titik akhir di set ke lokasi rental
            ],
    ...
    document.getElementById('locateMeBtn').addEventListener('click', function() {
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            control.spliceWaypoints(0, 1, currentLocation); // Set titik awal ke lokasi saat ini
            control.spliceWaypoints(control.getWaypoints().length - 1, 1, rentalLocation); // Set titik akhir ke lokasi rental
            map.setView(currentLocation, 15);
